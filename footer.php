...
COMP PolyU HongKong<br/>
    ...
    <address>
        ...
        <span title="email">Anna:</span><a href="mailto:anna.huang@connect.polyu.hk">16010922X@connect.polyu.hk</a><br/>
        <span title="email">Laura:</span><a href="mailto:anna.huang@connect.polyu.hk">16027789X@connect.polyu.hk</a><br>
